...
---
*For documentation on integrating the Plus APIs into your own app, see the [ShizukuX-API](https://github.com/thejaustin/ShizukuPlus-API) repository. For a full breakdown of every permission ShizukuX requests and why, see the [Permissions wiki page](https://github.com/thejaustin/ShizukuPlus/wiki/Permissions).*