...
public class ShizukuSettings {
    ...
    public static class Keys {
        ...
        // Home screen visibility (ShizukuX additions)
        ...
        // Home card extras (ShizukuX additions)
        ...
        // Legacy Compatibility (ShizukuX additions)
    ...
    // Auto Update Settings (ShizukuX additions)
    ...
    public static boolean isLiveActivityEnabled() { SharedPreferences p = getPreferences(); return p != null && p.getBoolean(Keys.KEY_LIVE_ACTIVITY_ENABLED, true); }
