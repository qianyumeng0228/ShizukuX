...
class BugReportDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val updateLink = getString(R.string.bug_report_dialog_link_update)
            .asLink("https://github.com/thejaustin/ShizukuX/releases/latest")

        val wikiLink = getString(R.string.bug_report_dialog_link_wiki)
            .asLink("https://github.com/thejaustin/ShizukuX/releases/wiki#troubleshooting")

        val issuesLink = getString(R.string.bug_report_dialog_link_issues)
            .asLink("https://github.com/thejaustin/ShizukuX/releases/issues")
        ...
        return MaterialAlertDialogBuilder(context)
            ...
            .setPositiveButton("GitHub") { _, _ ->
                CustomTabsHelper.launchUrlOrCopy(context, "https://github.com/thejaustin/ShizukuX/issues/new")
            }
