...
public class PlusShell {
    ...
    private static void printHelp() {
        System.out.println("ShizukuX CLI Helper (plus)");
    ...
    private static void handleVm(String[] args, IBinder binder) throws RemoteException {
        ...
        if (vmManager == null) {
            System.out.println("Error: VM Manager feature is disabled in ShizukuX settings.");
            return;
        }
    ...
    private static void handleAm(String[] args, IBinder binder) throws RemoteException {
        ...
        if (am == null) {
            System.out.println("Error: Activity Manager Plus feature is disabled in ShizukuX settings.");
            return;
        }
    ...
    private static void handleAiCore(String[] args, IBinder binder) throws RemoteException {
        ...
        if (aicore == null) {
            System.out.println("Error: AICore+ feature is disabled in ShizukuX settings.");
            return;
        }
    ...
    private static void handleStorage(String[] args, IBinder binder) throws RemoteException {
        ...
        if (storage == null) {
            System.out.println("Error: Storage Proxy feature is disabled in ShizukuX settings.");
            return;
        }
    ...
    private static void handleSpoof(IBinder binder) throws RemoteException {
        ...
        System.out.println("Note: Spoof targets are managed via ShizukuX Settings > Root Compatibility.");
    }

    private static void handleDoctor(IBinder binder) throws RemoteException {
        IShizukuService service = IShizukuService.Stub.asInterface(binder);
        System.out.println("ShizukuX System Doctor Diagnostics");
        System.out.println("==================================");
