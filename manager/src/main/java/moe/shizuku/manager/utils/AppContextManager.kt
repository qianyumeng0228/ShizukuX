...
object AppContextManager {
    ...
    private val staticDatabase = mutableMapOf<String, AppMetadata>().apply {
        ...
        put("dev.ukanth.ufirewall", AppMetadata("AFWall+: IPTables firewall. Use 'Network Governor' in ShizukuX for rootless control.", listOf(ENH_SHELL), true, "Menu > Preferences > SU path"))
