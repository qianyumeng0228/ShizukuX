...
**Trigger:** When the user asks to "audit code", "run linting", or "repair code smells".
**Purpose:** Automate the execution, parsing, and remediation of Android Lint warnings with minimal context bloat.
