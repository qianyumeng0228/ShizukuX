# Sentry Audit Skill
**Trigger:** When the user asks to "audit sentry", "check crashes", or "repair sentry issues".
**Purpose:** Minimize token usage while extracting actionable crash data from the Sentry REST API and mapping it to the local codebase.
