...
//        mManager = null;
    ...
    public static class Shizuku extends AppProcess {
        @NonNull
        @Override
        protected Process newProcess(@NonNull ProcessParams params) throws IOException {
            String[] cmd = params.getCmdList().toArray(new String[0]);
            Map<String, String> envMap = params.getEnv();
            String[] env = null;
            if (envMap != null) {
            ...
            return rikka.shizuku.Shizuku.newProcess(cmd, env, params.getDirectory());
        }
    }
