...
- **[thedjchi](https://github.com/thedjchi)** — For the intermediate fork and quality-of-life improvements, and for the field-verified **Android 17 (SDK 37) compatibility** approach — the hidden-API `deviceId` reflection and Local Network Protection handling — that ShizukuX's A17 support is adapted from.
