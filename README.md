...
Shizuku lets normal apps use system-level APIs directly via a privileged process started with adb or root. ShizukuX keeps full compatibility while adding quality-of-life improvements to the app management screen.
