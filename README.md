...
Get the latest release from [GitHub Releases](https://github.com/qianyumeng0228/ShizukuX/releases) — see the release notes there for what's changed recently.
...
*   **AICore+ Automation Bridge**: Privileged UI automation (hierarchy dumps, tap/swipe) for AI-driven tools — no root needed. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/e9bd1187))
*   **AVF (Virtual Machine) Manager**: Run isolated Linux/Microdroid VMs with GPU acceleration. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/c8e962f6))
*   **Privileged Storage Proxy**: Authenticated access to restricted paths (`/data/data/`, `/data/app/`) for backups and file management. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/c8e962f6))
*   **Device Spoofing** (*Spoof Device Identity* in Settings): Present a different device identity to bypass device-specific restrictions. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/11867f44))
*   **Intelligence Bridge** (*AI Core Plus*): Privileged NPU scheduling and screen context intelligence. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/e9bd1187))
*   **Window Manager Plus**: Force free-form resizing, manage the Bubble Bar, and resilient overlays. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/e9bd1187))
*   **System Theming Bridge** (*Overlay Manager Plus*): Privileged overlay management for rootless theming (e.g. Hex Installer). ([added](https://github.com/qianyumeng0228/ShizukuX/commit/55f6b7c7))
*   **Network & DNS Governor**: Manage Private DNS and firewall routing for rootless ad-blockers. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/55f6b7c7))
*   **Deep Process Control** (*Activity Manager Plus*): Lets process managers kill apps and set standby buckets more aggressively. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/55f6b7c7))
*   **Continuity Bridge**: Secure state and task handoff between ShizukuX devices. ([added](https://github.com/qianyumeng0228/ShizukuX/commit/20cf14f7))
...
See the [bundled API module](https://github.com/qianyumeng0228/ShizukuX/tree/master/api) for documentation on the exclusive Plus APIs.
