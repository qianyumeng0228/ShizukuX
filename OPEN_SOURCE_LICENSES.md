...
- **License**: Apache License 2.0
- **Usage**: Intermediate fork with additional quality-of-life changes that ShizukuX builds on top of
...
- **License**: Apache License 2.0
- **Usage**: Icons throughout the ShizukuX Manager UI
...
The ShizukuX source code itself is licensed under the [Apache License 2.0](LICENSE).
